    ...
    <form action="template/subcribe_form.php" method="post">
        <span><font face="verdana"color="black">Please enter email to receive the latest posts</font></span>
    ...
    <div id="texts" style="display:inline;"> 
                <h4><p><font face="verdana"color="black">Powered By The DevelopHers</font></p></h4>
